...
{
    public class StajKomiyonUyesiModel : PageModel
    {
        public void OnGet()
        {
        }
        ...
        public IActionResult OnGetIslemeAlSKU(string ID , string KomisyonOnay,string KominyonOnayEx, string KomisyonOnaylananHoca)
        {
            ...
            string SQL = "UPDATE Project " +
                "SET KOMISYONONAY = " + KomisyonOnay +
                " , KomisyonOnayAçýklama = '" + KominyonOnayEx + "'" +
